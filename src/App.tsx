...
const frutas = ["manzana", "banana", "cereza", "mandarina", "higo", "uva", "kiwi"];
...
const words = [frutas,figuras,colores,electrodomesticos]
const pistas = {
    frutas: {
...
function App() {
    ...
    return (
        <div className='App'>
            {start ? (
                <Hangman words={words[random]} pista={pistas[Object.keys(pistas)[random]]} />
            ) : (
